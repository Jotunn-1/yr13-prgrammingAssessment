...
void Enemy::tempPathFinder( int player_posx, int player_posy, float *time_step )
{
  if( m_posx > player_posx )
  {
    m_posx -= ENEMY_VEL * *time_step;
  }
  else if( m_posx < player_posx )
  {
    m_posx += ENEMY_VEL * *time_step;
  }
