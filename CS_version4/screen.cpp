//Johnathan Regha-Dodge: CS_version4/screen.cpp
...
void Screen::renderSeq( Player *player, Enemies *enemies, Texture *texture, Texture *texture_2, Texture *texture_3)
{
  ...
  enemies->tempEnemiesRender( m_renderer, texture_3 );
